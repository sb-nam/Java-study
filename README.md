...
- [콘솔 출력](#콘솔-출력)
- [오버로딩(Overloading) 과 오버라이딩(Overriding)](#오버로딩-오버라이딩)
...
class ColorPointRun {
    ...
    public static void main(String[] args) {
        ...
        ColorPoint zp = new ColorPoint(); // 0,0 위치의 검정색 점.
...
class Point3DRun {
    ...
    public static void main(String [] args) {
        ...
        p.moveUp(); // z 축 위쪽으로 이동.
        System.out.println(p.toString()+"입니다.");

        p.moveDown(); // z 축 아래쪽으로 이동.
...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		//벡터 중간에 삽입하기
		v.add(2,100); // 4와 -1 사이의 정수 100 삽입

	    System.out.println("백터 내의 요소 객체 수 :" + v.size()); //크기 3
	    System.out.println("벡터 내의 현재 용량 : " + v.capacity()); // 벡터 용량 10
...
public class StackApp {
    ...
    public static void main(String [] args) {
        ...
        item.setItem("dd");
        String text = (String) item.getItem();

        Item3<Integer> item3 = new Item3<>();
        item.setItem(1);
        int text2 = item3.getItem();
    }
